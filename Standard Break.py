...
def consolidate(folder):
    ...
    for i in range(len(list(time))):
        ...
        print('strain at break ' + str(i) + ':' + breakstrain)
...
#        
#                     
consolidate('L:\\Instron 5967-1\\19-0059\\1000 Hours\\19-0059 1376-6 1000 Hours\\19-0059 1376-6 1000 Hours.is_tens_RawData')